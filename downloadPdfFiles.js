...
module.exports.download = function (respJsonPath, cb) {
    down(respJsonPath, cb)
};
...
function downloadPDFToLocal(file_path, allFiles, currFile, cb) {
    ...
    async.eachLimit(json, 1, function(obj,next) {basicDownload(obj,pdfs_dir,num, next)}, function () {
...
function basicDownload(obj, pdfs_dir,num,next) {
    var d = "";
    try {
